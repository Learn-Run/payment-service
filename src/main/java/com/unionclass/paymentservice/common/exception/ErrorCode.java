package com.unionclass.paymentservice.common.exception;
...
public enum ErrorCode {
    ...
    FAILED_TO_GET_PAYMENT_DETAIL_INFO(HttpStatus.INTERNAL_SERVER_ERROR, false, 8020, "결제 상세 정보 조회에 실패하였습니다."),
